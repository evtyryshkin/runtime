...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AccomponnistLibraryAccessors laccForAccomponnistLibraryAccessors = new AccomponnistLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>ktlint</b> with <b>org.jlleitschuh.gradle:ktlint-gradle</b> coordinates and
    ...
    /**
     * Dependency provider for <b>okHttpClient</b> with <b>com.squareup.okhttp3:okhttp</b> coordinates and
     * with version reference <b>okHttpClient</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getOkHttpClient() {
     ...
     * with version reference <b>testCoreKtx</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Group of libraries at <b>accomponnist</b>
     */
    public AccomponnistLibraryAccessors getAccomponnist() {
        return laccForAccomponnistLibraryAccessors;
    }
    ...
    public static class AccomponnistLibraryAccessors extends SubDependencyFactory {

        public AccomponnistLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>permissions</b> with <b>com.google.accompanist:accompanist-permissions</b> coordinates and
         * with version <b>0.34.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPermissions() {
            return create("accomponnist.permissions");
        }
    ...
    public static class MapsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltAndroidTesting</b> with value <b>2.51.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>java</b> with value <b>1.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>okHttpClient</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOkHttpClient() { return getVersion("okHttpClient"); }
        ...
        /**
         * Version alias <b>testCoreKtx</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTestCoreKtx() { return getVersion("testCoreKtx"); }

        /**
         * Version alias <b>uiTestJunit4</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>kotlin.compiler</b> with value <b>1.5.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompiler() { return getVersion("kotlin.compiler"); }
    ...
    public static class KtlintVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ktlint.version</b> with value <b>0.47.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SecretsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>secrets.plugin</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlugin() { return getVersion("secrets.plugin"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>ktlintPlugin</b> with plugin id <b>org.jlleitschuh.gradle.ktlint</b> and
         * with version reference <b>ktlint.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKtlintPlugin() { return createPlugin("ktlintPlugin"); }

        /**
         * Plugin provider for <b>secretsPlugins</b> with plugin id <b>com.google.android.libraries.mapsplatform.secrets-gradle-plugin</b> and
         * with version reference <b>secrets.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSecretsPlugins() { return createPlugin("secretsPlugins"); }
